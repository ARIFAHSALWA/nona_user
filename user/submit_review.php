...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $rating = $_POST['rating'];
    $review = $_POST['review'];
    $category = 'default'; // Ubah sesuai dengan input kategori di form Anda
    ...
    if (move_uploaded_file($_FILES["photo"]["tmp_name"], $target_file)) {
        ...
        $sql = "INSERT INTO reviews (name, rating, review, category, photo) VALUES ('$name', '$rating', '$review', '$category', '$target_file')";
